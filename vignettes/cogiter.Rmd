...
En plus des aggrégats epci, départements, région, la fonction cogifier permet de calculer : 

- le total France métro (`metro = T`)
- le total France métro et DROM (`metrodrom = T`)
- le total Départements et régions d'outre mer (`drom = T`)
- le total France de province (`franceprovince = T`)
