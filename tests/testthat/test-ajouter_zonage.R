test_that("ajouter_typologie fonctionne", {
  ...
  cogpop2015 <- cogifier(pop2015, metrodrom = TRUE)
  cogpop2015aav <- ajouter_typologie(cogpop2015, zonage_df = zonage_aav)
...
test_that("ajouter_typologie fonctionne", {
  ...
  cogpop2015 <- cogifier(pop2015, metrodrom = TRUE)
  cogpop2015aav <- ajouter_zonage(cogpop2015, zonage_df = zonage_aav)
  sum_avv <- cogpop2015aav %>%
